...
<script type="text/javascript">
	var setHiddenParameter = function(data) {
		document.addvoter.clickedLink.value = data;
		document.addvoter.submit();
	}
</script>
...
<body class="bg-black">
	...
	<div class="form-box" id="login-box">
		<div class="header">Add New Voter</div>
		<form action="AddVoterServlet" method="post" name="addvoter">
			<%
			...
			<div class="footer" align="right">
				<div class="btn-group">
					...
					<button type="button" onclick='setHiddenParameter("addcandidate")'
						class="btn bg-olive btn-flat margin">Add Voter</button>
				</div>
